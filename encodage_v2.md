...
En informatique, un bit représente symboliquement un $0$ ou un $1$, de plus, sachez que le terme __bit__ vient de la contraction de __binary digit__ (__chiffre binaire__ en français).
