...
Enfin, n'oublions pas que la fin du chapitre précédent évoque le sujet d'une propriété de la __notation positionnelle__ qui s'applique à n'importe quel base numérique.


Enfin, n'oublions pas que l'une des propriétés (particulièrement importante) de la __notation positionnelle__ s'applique à n'importe quel base numérique, ce sujet ayant été abordé à la fin du chapitre précédent.
