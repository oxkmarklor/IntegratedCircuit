...
Lorsque cette propriété est appliqué à la base binaire, elle nous fait réaliser que pour tout nombre écrit en base $2$, et entre autre, tout nombre entier naturel : la valeur d'un bit à $1$ de poids $i$ est strictement supérieur à la somme des valeurs des bits de poids inférieur à $i$.

Cette propriété appliquée à la base binaire nous dit que pour tout nombre binaire, et entre autre, tout nombre entier naturel : la valeur d'un bit à $1$ de poids $i$ est strictement supérieur à la somme des valeurs des bits de poids inférieur à $i$.
