...
Tout nombre que manipule un ordinateur n'est ainsi qu'un ensemble fini de bit, du nom de __champ binaire__, et d'une taille standardisé qui varie entre $8$, $16$, $32$ et $64$ bits dans le cas général.
